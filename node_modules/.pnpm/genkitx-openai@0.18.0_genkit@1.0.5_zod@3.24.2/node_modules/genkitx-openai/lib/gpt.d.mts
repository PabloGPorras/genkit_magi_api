import { CandidateData, GenerateResponseChunkData, ModelAction } from 'genkit/model';
 ...
 */
declare function gptModel(ai: Genkit, name: string, client: OpenAI): ModelAction<typeof OpenAiConfigSchema>;
