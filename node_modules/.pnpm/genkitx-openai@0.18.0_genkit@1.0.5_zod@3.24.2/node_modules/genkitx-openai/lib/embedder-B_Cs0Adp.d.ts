...
interface PluginOptions extends ClientOptions {
}
/**
 ...
 * ```
 */
declare const openAI: (options?: PluginOptions) => genkit_plugin.GenkitPlugin;
...
declare function openaiEmbedder(ai: Genkit, name: string, options?: PluginOptions): genkit.EmbedderAction<z.ZodObject<{
    dimensions: z.ZodOptional<z.ZodNumber>;
    encodingFormat: z.ZodOptional<z.ZodUnion<[z.ZodLiteral<"float">, z.ZodLiteral<"base64">]>>;
}, "strip", z.ZodTypeAny, {
    dimensions?: number | undefined;
